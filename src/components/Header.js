    ...
    <div className='absolute w-full px-4 py-3 bg-gradient-to-b from-black z-10 flex flex-wrap justify-between items-center'>
      ...
      {user && (
        <div className='flex flex-wrap items-center'>
          {showGptSearch && (
            <select className='px-2 py-1 mr-2 mt-2 bg-gray-900 text-white rounded-md' onChange={handleLanguageChange}>
          ...
          <button 
            className='px-4 py-2 mx-2 mt-2 bg-purple-800 text-white rounded-lg'
            onClick={handleGptSearchClick}>
            {showGptSearch ? "Homepage" : "GPT SEARCH"}
          </button>
